...
<form method="POST" action="{{ route('soal-tryout.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
<div class="row">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Tambah Soal </h4>
                        ...
                        <!--         <input id="soal" type="text" class="form-control" name="soal" value="{{ old('soal') }}" required>
                                @if ($errors->has('soal'))
                     ...
                     -->        </div>
                        ...
                        <div class="form-group{{ $errors->has('Jenis Soal') ? ' has-error' : '' }}">
                            <label for="Jenis Soal" class="col-md-4 control-label">Jenis Soal</label>
                            <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('Jenis Soal') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="pelajaran" required="">
                                ...
                                <option value="6">TPA</option>
                                <option value="7">Fisika</option>
                                <option value="8">Sosiolgi</option>
                                <option value="9">Biologi</option>
                                <option value="10">Kimia</option>
